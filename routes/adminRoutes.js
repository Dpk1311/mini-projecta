...
router.get('/editcategory/:productId',adminController.editcategory)
router.post('/editcategory/:productId',upload.single('Image'),adminController.editcategorypost)
router.get('/categorydelete/:productId',adminController.categorydelete)
...
router.get('/adminorderdetail',adminController.adminoderdetail)
...
router.get('/couponedit/:couponid',couponController.couponedit)
